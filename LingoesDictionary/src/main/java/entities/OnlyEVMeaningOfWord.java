 ...
 * @author huyvi
 */
public class OnlyEVMeaningOfWord {
    private String meaning;
    private List<String> examples;
    private List<String> attachedPrepositions;

    public OnlyEVMeaningOfWord() {
    }

    public OnlyEVMeaningOfWord(String meaning, List<String> examples, List<String> attachedPrepositions) {
    ...
    public boolean equals(Object obj) {
        ...
        OnlyEVMeaningOfWord tmp = (OnlyEVMeaningOfWord) obj;
